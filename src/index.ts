...
export class ImageProcessorServer {
	...
	private async processImage(
		...
		try {
			...
			pipeline = pipeline.normalise().linear(
			...
			async () => ({
				resourceTemplates: [
					...
					},
					{
						...
						description:
							"Get image processing statistics for a specific month (YYYY-MM format)",
						mimeType: "application/json",
					},
				],
			})
			...
			resources: [
				{
					...
					description:
						"Overall image processing statistics and performance metrics",
					mimeType: "application/json",
				},
				{
					...
					description:
						"Available image optimization presets and their settings",
					mimeType: "application/json",
				},
			],
		}));
